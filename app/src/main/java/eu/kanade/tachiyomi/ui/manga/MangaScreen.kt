...
class MangaScreen(
    ...
    override fun Content() {
        ...
        MangaScreen(
            ...
            onTranslationClick = screenModel::runChapterTranslationActions.takeIf { !successState.source.isLocalOrStub() },
            translationProgressProvider = screenModel::getTranslationProgress,
